...
typedef NS_ENUM(NSUInteger, SVProgressHUDMaskType) {
    ...
    SVProgressHUDMaskTypeClear,     // don't allow user interactions不允许用户进行其他界面操作）
    SVProgressHUDMaskTypeBlack,     // don't allow user interactions and dim the UI in the back of the HUD不允许用户进行其他界面操作）
    SVProgressHUDMaskTypeGradient   // don't allow user interactions and dim the UI with a a-la-alert-view background gradient不允许用户进行其他界面操作）
};
